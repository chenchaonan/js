...
~function () {
     ...
     * effect {Number}|{Array}运动方式 可以是Number 0 1  3，Array：['Quint','easeInOut']
    ...
    function animate(options) {
        ...
        //处理元素curEle
        if (!curEle) {
            console.warn('未指定目标元素');
            return
        }
        //防止动画累积，每次执行动画之前清除上一次的动画之后在执行新动画。
        curEle._timer && clearInterval(curEle._timer);
        //处理运动方式effect
        if (typeof effect === 'number') {
            switch (effect) {
                case 0:
                    ...
                    break;
                case 1:
                    effect = zhufengEffect.Bounce.easeInOut;
                    break;
                case 2:
                    effect = zhufengEffect.Bounce.easeIn;
                    break;
                default :
                    effect = zhufengEffect.Circ.easeIn;
            }
        } else if (effect instanceof Array) {//数组方式指定运动方式['Quint','easeInOut']
